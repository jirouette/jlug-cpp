...
*/
jlug::AnimatedPlayer::AnimatedPlayer(jlug::ImageManager& imageM, jlug::Input& in):
                                jlug::Character::Character(imageM),
                                jlug::Player::Player(imageM, in),
...
*/
jlug::AnimatedPlayer::AnimatedPlayer(unsigned int cid, const std::string& cname, jlug::ImageManager& imageM, jlug::Input& in):
                                jlug::Character::Character(cid, cname, imageM),
                                jlug::Player::Player(cid, cname, imageM, in),
...
jlug::AnimatedPlayer::AnimatedPlayer(unsigned int cid, const std::string& cname, unsigned int posx, unsigned int posy, jlug::ImageManager& imageM, jlug::Input& in):
                                jlug::Character::Character(cid, cname, posx, posy, imageM),
                                jlug::Player::Player(cid, cname, posx, posy, imageM, in),
...
jlug::AnimatedPlayer::AnimatedPlayer(unsigned int cid, const std::string& cname, unsigned int posx, unsigned int posy, unsigned int posz, jlug::ImageManager& imageM, jlug::Input& in):
                                jlug::Character::Character(cid, cname, posx, posy, posz, imageM),
                                jlug::Player::Player(cid, cname, posx, posy, posz, imageM, in),
